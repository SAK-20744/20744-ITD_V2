...
public class CharlieBlueAuto extends OpMode {
    ...
    public void setBackdropGoalPose() {
        switch (navigation) {
            ...
            case "left":
                ...
                initialBackdropGoalPose = new Pose(blueLeftBackdrop.getX() - 2, blueLeftBackdrop.getY()-ROBOT_BACK_LENGTH-0.75, Math.PI * 1.5);
                firstCycleBackdropGoalPose = new Pose(blueRightBackdrop.getX() - 1, blueRightBackdrop.getY()-ROBOT_BACK_LENGTH+0.75, Math.PI * 1.5);
                secondCycleBackdropGoalPose = new Pose(blueRightBackdrop.getX() - 1, blueRightBackdrop.getY()-ROBOT_BACK_LENGTH+0.75, Math.PI * 1.5);
                break;
            case "middle":
                spikeMarkGoalPose = new Pose(blueLeftSideMiddleSpikeMark.getX() - 1.25, blueLeftSideMiddleSpikeMark.getY()+3, Math.PI/2);
                initialBackdropGoalPose = new Pose(blueMiddleBackdrop.getX() - 1.25, blueMiddleBackdrop.getY()-ROBOT_BACK_LENGTH-1,Math.PI * 1.5);
                firstCycleBackdropGoalPose = new Pose(blueRightBackdrop.getX()+0.5, blueRightBackdrop.getY()-ROBOT_BACK_LENGTH+0.5, Math.PI * 1.5);
                secondCycleBackdropGoalPose = new Pose(blueRightBackdrop.getX()+0.5, blueRightBackdrop.getY()-ROBOT_BACK_LENGTH+0.75, Math.PI * 1.5);
                break;
            case "right":
                spikeMarkGoalPose = new Pose(blueLeftSideRightSpikeMark.getX() + 2, blueLeftSideRightSpikeMark.getY()+0.5, Math.PI/2);
                initialBackdropGoalPose = new Pose(blueRightBackdrop.getX()+1,blueRightBackdrop.getY()-ROBOT_BACK_LENGTH-1, Math.PI * 1.5);
                firstCycleBackdropGoalPose = new Pose(blueMiddleBackdrop.getX() - 2.5, blueRightBackdrop.getY()-ROBOT_BACK_LENGTH+0.75, Math.PI * 1.5);
                secondCycleBackdropGoalPose = new Pose(blueRightBackdrop.getX() - 2, blueRightBackdrop.getY()-ROBOT_BACK_LENGTH+0.75, Math.PI * 1.5);
                break;
        }
    }
    ...
    public void buildPaths() {
        ...
        switch (navigation) {
            default:
            case "left":
                firstCycleStackPose = new Pose(blueInnerStack.getX()+2.75, blueInnerStack.getY() + ROBOT_FRONT_LENGTH+2.5, Math.PI * 1.5 + Math.toRadians(4));
                secondCycleStackPose = new Pose(blueInnerStack.getX()+2, blueInnerStack.getY() + ROBOT_FRONT_LENGTH+1, Math.PI * 1.5 + Math.toRadians(3));
                break;
            case "middle":
                firstCycleStackPose = new Pose(blueInnerStack.getX()+0.5, blueInnerStack.getY() + ROBOT_FRONT_LENGTH+0.5, Math.PI * 1.5 + Math.toRadians(3.5));
                secondCycleStackPose = new Pose(blueInnerStack.getX()+1, blueInnerStack.getY() + ROBOT_FRONT_LENGTH-0.25, Math.PI * 1.5 + Math.toRadians(2.5));
                break;
            case "right":
                firstCycleStackPose = new Pose(blueInnerStack.getX()+3.5, blueInnerStack.getY() + ROBOT_FRONT_LENGTH, Math.PI * 1.5 + Math.toRadians(3));
                secondCycleStackPose = new Pose(blueInnerStack.getX()+5, blueInnerStack.getY() + ROBOT_FRONT_LENGTH - 0.5, Math.PI * 1.5 + Math.toRadians(0));
                break;
        }
