...
import static org.firstinspires.ftc.teamcode.util.Constants.INTAKE_ARM_STACK_MIDDLE_POSITION;
import static org.firstinspires.ftc.teamcode.util.Constants.INTAKE_ARM_STACK_TOP_POSITION;
...
import static org.firstinspires.ftc.teamcode.util.Constants.OUTTAKE_ARM_CYCLE_FIRST_SCORE_POSITION;
import static org.firstinspires.ftc.teamcode.util.Constants.OUTTAKE_ARM_CYCLE_SECOND_SCORE_POSITION;
...
public class RedRightInnerAuto extends OpMode {
    ...
    public void setBackdropGoalPose() {
        switch (navigation) {
            ...
            case "left":
                ...
                initialBackdropGoalPose = new Pose(redLeftBackdrop.getX(), redLeftBackdrop.getY() - ROBOT_BACK_LENGTH - 2.5, Math.PI * 1.5);
                firstCycleBackdropGoalPose = new Pose(redMiddleBackdrop.getX() + 3.5, redLeftBackdrop.getY() - ROBOT_BACK_LENGTH + 0.25, Math.PI * 1.5);
                secondCycleBackdropGoalPose = new Pose(redLeftBackdrop.getX() + 4.5, redLeftBackdrop.getY() - ROBOT_BACK_LENGTH - 0.25, Math.PI * 1.5);
                break;
            case "middle":
                spikeMarkGoalPose = new Pose(redRightSideMiddleSpikeMark.getX(), redRightSideMiddleSpikeMark.getY() + 4, Math.PI / 2);
                initialBackdropGoalPose = new Pose(redMiddleBackdrop.getX() + 2.75, redMiddleBackdrop.getY() - ROBOT_BACK_LENGTH - 2.75, Math.PI * 1.5);
                firstCycleBackdropGoalPose = new Pose(redLeftBackdrop.getX() + 1.25, redLeftBackdrop.getY() - ROBOT_BACK_LENGTH - 1, Math.PI * 1.5);
                secondCycleBackdropGoalPose = new Pose(redLeftBackdrop.getX() + 3, redLeftBackdrop.getY() - ROBOT_BACK_LENGTH - 0.5, Math.PI * 1.5);
                break;
            case "right":
                spikeMarkGoalPose = new Pose(redRightSideRightSpikeMark.getX() - 2, redRightSideRightSpikeMark.getY() + 0.5, Math.PI / 2);
                initialBackdropGoalPose = new Pose(redRightBackdrop.getX() + 2, redRightBackdrop.getY() - ROBOT_BACK_LENGTH - 2.5, Math.PI * 1.5);
                firstCycleBackdropGoalPose = new Pose(redLeftBackdrop.getX() + 3, redLeftBackdrop.getY() - ROBOT_BACK_LENGTH - 0.5, Math.PI * 1.5);
                secondCycleBackdropGoalPose = new Pose(redLeftBackdrop.getX() + 5.25, redLeftBackdrop.getY() - ROBOT_BACK_LENGTH + 0, Math.PI * 1.5);
                break;
        }
    }
    ...
    public void buildPaths() {
        ...
        switch (navigation) {
            default:
            case "left":
                firstCycleStackPose = new Pose(redInnerStack.getX(), redInnerStack.getY() + ROBOT_FRONT_LENGTH - 0.85, Math.PI * 1.5 - Math.toRadians(3));
                secondCycleStackPose = new Pose(redInnerStack.getX(), redInnerStack.getY() + ROBOT_FRONT_LENGTH - 1.35, Math.PI * 1.5 - Math.toRadians(1));
                break;
            case "middle":
                firstCycleStackPose = new Pose(redInnerStack.getX(), redInnerStack.getY() + ROBOT_FRONT_LENGTH + 1, Math.PI * 1.5 - Math.toRadians(2));
                secondCycleStackPose = new Pose(redInnerStack.getX(), redInnerStack.getY() + ROBOT_FRONT_LENGTH + 0.5, Math.PI * 1.5 - Math.toRadians(2));
                break;
            case "right":
                firstCycleStackPose = new Pose(redInnerStack.getX(), redInnerStack.getY() + ROBOT_FRONT_LENGTH + 2, Math.PI * 1.5 - Math.toRadians(3));
                secondCycleStackPose = new Pose(redInnerStack.getX(), redInnerStack.getY() + ROBOT_FRONT_LENGTH + 1.35, Math.PI * 1.5 - Math.toRadians(2.5));
                break;
        }
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 17:
                ...
                backdropCorrection(initialBackdropGoalPose, 1.8);
                if (pathTimer.getElapsedTime() > 500) {
                    setPathState(18);
                }
                break;
            ...
            case 210:
                ...
                backdropCorrection(firstCycleBackdropGoalPose, 1.4);
                if (pathTimer.getElapsedTime() > 500) {
                    setPathState(211);
                }
                break;
            ...
            case 310:
                ...
                backdropCorrection(secondCycleBackdropGoalPose, 1.4);
                if (pathTimer.getElapsedTime() > 500) {
                    setPathState(311);
                }
                break;
